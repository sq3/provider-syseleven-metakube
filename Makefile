...
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-metakube
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/syseleven/terraform-provider-metakube/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
