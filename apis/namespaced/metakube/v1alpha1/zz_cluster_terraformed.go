...
func (mg *Cluster) GetTerraformResourceType() string {
	return "metakube_cluster"
}

// GetConnectionDetailsMapping for this Cluster
func (tr *Cluster) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"kube_config": "status.atProvider.kubeConfig", "oidc_kube_config": "status.atProvider.oidcKubeConfig", "spec[*].cloud[*].aws[*].access_key_id": "spec[*].cloud[*].aws[*].accessKeyIdSecretRef", "spec[*].cloud[*].aws[*].secret_access_key": "spec[*].cloud[*].aws[*].secretAccessKeySecretRef", "spec[*].cloud[*].azure[*].client_secret": "spec[*].cloud[*].azure[*].clientSecretSecretRef", "spec[*].cloud[*].openstack[*].application_credentials[*].secret": "spec[*].cloud[*].openstack[*].applicationCredentials[*].secretSecretRef", "spec[*].cloud[*].openstack[*].user_credentials[*].password": "spec[*].cloud[*].openstack[*].userCredentials[*].passwordSecretRef", "spec[*].cloud[*].openstack[*].user_credentials[*].username": "spec[*].cloud[*].openstack[*].userCredentials[*].usernameSecretRef"}
}
